...
public class DotExpression_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_t2jtrp_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new DotExpression_Editor.leftExpressionSingleRoleHandler_t2jtrp_a0(node, MetaAdapterFactory.getContainmentLink(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x6168f46017301b6eL, 0x6168f46017301b72L, "leftExpression"), editorContext);
    return provider.createCell();
  }
  private class leftExpressionSingleRoleHandler_t2jtrp_a0 extends SingleRoleCellProvider {
    public leftExpressionSingleRoleHandler_t2jtrp_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_t2jtrp_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new DotExpression_Editor.rightExpressionSingleRoleHandler_t2jtrp_c0(node, MetaAdapterFactory.getContainmentLink(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x6168f46017301b6eL, 0x6168f46017301b74L, "rightExpression"), editorContext);
    return provider.createCell();
  }
  private class rightExpressionSingleRoleHandler_t2jtrp_c0 extends SingleRoleCellProvider {
    public rightExpressionSingleRoleHandler_t2jtrp_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    public EditorCell createChildCell(EditorContext editorContext, SNode child) {
      EditorCell editorCell = super.createChildCell(editorContext, child);
