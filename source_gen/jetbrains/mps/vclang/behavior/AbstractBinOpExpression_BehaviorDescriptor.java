...
public final class AbstractBinOpExpression_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static Boolean isSurroundedWithBraces_id2nfHNdzS$N4(@NotNull SNode __thisNode__) {
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(__thisNode__), MetaAdapterFactory.getConcept(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x62a6e9940367a261L, "jetbrains.mps.vclang.structure.AbstractBinOpExpression"))) {
      ...
      int pp = AbstractBinOpExpression_BehaviorDescriptor.getPriority_id6FOQVYN5Gn2.invoke(parent);
      int tp = AbstractBinOpExpression_BehaviorDescriptor.getPriority_id6FOQVYN5Gn2.invoke(__thisNode__);
      if (pp > tp) {
        return true;
      }
      if (pp == tp) {
        int pa = AbstractBinOpExpression_BehaviorDescriptor.getAssociativity_id6FOQVYN5Kbs.invoke(parent);
        int ta = AbstractBinOpExpression_BehaviorDescriptor.getAssociativity_id6FOQVYN5Kbs.invoke(__thisNode__);
        if (pa != ta) {
          return true;
        }
        int role = -1;
        ...
        if (role != AbstractBinOpExpression_BehaviorDescriptor.getAssociativity_id6FOQVYN5Kbs.invoke(__thisNode__)) {
          return true;
        }
      }
    }
  ...
  /*package*/ AbstractBinOpExpression_BehaviorDescriptor() {
    super(REGISTRY);
  }
