...
public final class PiExpression_BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x62a6e9940367a264L, "jetbrains.mps.vclang.structure.PiExpression");
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    SNode ta = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(MetaAdapterFactory.getInterfaceConcept(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x634b3353f5ace245L, "jetbrains.mps.vclang.structure.ITypedArgument")));
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0xc23f5510097501bL, 0xc23f5510097501cL, "args"))).addElement(ta);
  }

  private static Abstract.Expression toSourceExpression_id6mU6lSbK89M(@NotNull SNode __thisNode__) {
    return new PiExpressionAdapter(__thisNode__);
  }
  private static Boolean isRightMost_id24ni4bqdMc_(@NotNull SNode __thisNode__, SNode child) {
    return SNodeOperations.getParent(child) == __thisNode__ && SNodeOperations.hasRole(child, MetaAdapterFactory.getContainmentLink(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x62a6e9940367a264L, 0x62a6e9940367d382L, "codomain"));
  }

  /*package*/ PiExpression_BehaviorDescriptor() {
    super(REGISTRY);
  }
