...
public final class HasArguments_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getArguments_id1$0zzZHWG3G = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getArguments").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1$0zzZHWG3G").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses(Boolean.TYPE)));
  ...
  public static final SMethod<List<Abstract.Argument>> getSourceArguments_id5NQyKEZFwKp = new SMethodBuilder<List<Abstract.Argument>>(new SJavaCompoundTypeImpl((Class<List<Abstract.Argument>>) ((Class) Object.class))).name("getSourceArguments").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("5NQyKEZFwKp").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static List<SNode> getArguments_id1$0zzZHWG3G(@NotNull SNode __thisNode__, boolean onlyExplicit) {
  ...
  private static Scope getScope_id3fifI_xCJOQ(@NotNull SNode __thisNode__, SNode kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), MetaAdapterFactory.getInterfaceConcept(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x13b91a232b9ddd05L, "jetbrains.mps.vclang.structure.IVariable"))) {
      return new VcNameHidingScope(CompositeWithParentScope.parentScope(__thisNode__, kind), ListScope.forNamedElements(HasArguments_BehaviorDescriptor.getArguments_id1$0zzZHWG3G.invoke(__thisNode__, false)));
    }
    return ScopeProvider_BehaviorDescriptor.getScope_id3fifI_xCJOQ.invokeSpecial(__thisNode__, kind, child);
  }
  private static List<Abstract.Argument> getSourceArguments_id5NQyKEZFwKp(@NotNull SNode __thisNode__) {
    ...
    for (SNode arg : ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0xc23f5510097501bL, 0xc23f5510097501cL, "args")))) {
      if (SNodeOperations.isInstanceOf(arg, MetaAdapterFactory.getConcept(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x62a6e9940367a6c1L, "jetbrains.mps.vclang.structure.TelescopeArgument")) && (SLinkOperations.getTarget(SNodeOperations.cast(arg, MetaAdapterFactory.getConcept(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x62a6e9940367a6c1L, "jetbrains.mps.vclang.structure.TelescopeArgument")), MetaAdapterFactory.getContainmentLink(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x634b3353f5ace245L, 0x62a6e9940367a6bfL, "typeExpr")) == null)) {
        ...
        ListSequence.fromList(result).addElement(AbstractArgument_BehaviorDescriptor.toSourceArgument_id6mU6lSbLceY.invoke(arg));
      }
    }
    return result;
  }

  /*package*/ HasArguments_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) getArguments_id1$0zzZHWG3G(node, (Boolean) parameters[0]);
      case 1:
        return (T) getScope_id3fifI_xCJOQ(node, (SNode) parameters[0], (SNode) parameters[1]);
      case 2:
        return (T) getSourceArguments_id5NQyKEZFwKp(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
