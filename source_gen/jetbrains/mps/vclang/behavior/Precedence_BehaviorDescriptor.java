...
public final class Precedence_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static Abstract.Definition.Precedence toSourcePrecedence_id5NQyKEZHnxj(@NotNull SNode __thisNode__) {
  ...
  /*package*/ Precedence_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) toSourcePrecedence_id5NQyKEZHnxj(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
