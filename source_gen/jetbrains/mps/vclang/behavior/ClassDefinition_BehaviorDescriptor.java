...
public final class ClassDefinition_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getMembers_id2jcrgspE4NS = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getMembers").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("2jcrgspE4NS").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  public static final SMethod<List<SNode>> getStaticMembersIncludingExported_id2jcrgspEawz = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getStaticMembersIncludingExported").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("2jcrgspEawz").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  public static final SMethod<List<SNode>> getDependencies_id5LKdqeczslD = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getDependencies").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("5LKdqeczslD").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  private static Scope getScope_id3fifI_xCJOQ(@NotNull SNode __thisNode__, SNode kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), MetaAdapterFactory.getConcept(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0xfc408c778ec7ec8L, "jetbrains.mps.vclang.structure.Definition")) && SNodeOperations.hasRole(child, MetaAdapterFactory.getContainmentLink(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0xfc408c778ec305aL, 0xfc408c778ec7ec9L, "statements"))) {
      ...
      for (SNode def : ListSequence.fromList(prevDefs)) {
        SNode definition = IClassMember_BehaviorDescriptor.getDefinition_id24ni4bpKruo.invoke(def);
        if ((definition != null) && !(SNodeOperations.getConcept(definition).isAbstract())) {
          Definition_BehaviorDescriptor.addArtifacts_id24ni4bq6hxj.invoke(definition, result);
        }
      ...
      }
      {
        ...
        while (importedClass_it.hasNext()) {
          ...
          ListSequence.fromList(result).addSequence(ListSequence.fromList(ClassDefinition_BehaviorDescriptor.getStaticMembersIncludingExported_id2jcrgspEawz.invoke(importedClass_var)));
        }
      }
  ...
  private static List<SNode> getMembers_id2jcrgspE4NS(@NotNull SNode __thisNode__) {
    List<SNode> result = new ArrayList<SNode>();
    {
  ...
  private static List<SNode> getStaticMembersIncludingExported_id2jcrgspEawz(@NotNull SNode __thisNode__) {
  ...
  private static List<SNode> getDependencies_id5LKdqeczslD(@NotNull SNode __thisNode__) {
  ...
  /*package*/ ClassDefinition_BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @NotNull Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 1:
        return (T) getMembers_id2jcrgspE4NS(node);
      case 2:
        return (T) getStaticMembersIncludingExported_id2jcrgspEawz(node);
      case 3:
      ...
      case 8:
        return (T) getDependencies_id5LKdqeczslD(node);
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
