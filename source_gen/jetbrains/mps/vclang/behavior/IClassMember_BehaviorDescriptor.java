...
public final class IClassMember_BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Abstract.Statement> toSourceStatement_id3wdrnIK4lOW = new SMethodBuilder<Abstract.Statement>(new SJavaCompoundTypeImpl(Abstract.Statement.class)).name("toSourceStatement").modifiers(SModifiersImpl.create(12, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3wdrnIK4lOW").registry(REGISTRY).build(SParameterImpl.fromList(SJavaCompoundTypeImpl.fromClasses()));
  ...
  /*package*/ IClassMember_BehaviorDescriptor() {
    super(REGISTRY);
  }
