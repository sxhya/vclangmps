...
public final class IValidFunctionalSymbol__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static boolean isCorrectFunctionalSymbol_id6oOmj_ocr1W(@NotNull SAbstractConcept __thisConcept__, String name) {
    return REGEXP_z3s3o7_a0a0a9.matcher(name).matches();
  }

  /*package*/ IValidFunctionalSymbol__BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((Boolean) isCorrectFunctionalSymbol_id6oOmj_ocr1W(concept, (String) parameters[0]));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
  ...
  private static Pattern REGEXP_z3s3o7_a0a0a9 = Pattern.compile("[~!@#\\$%\\^&\\*\\\\\\-\\+=<>\\?/:\\|]+", 0);
}
