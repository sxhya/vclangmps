...
public final class NewExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x134a75c14102d4e1L, "jetbrains.mps.vclang.structure.NewExpression");
  ...
  /*package*/ static Abstract.Expression toSourceExpression_id6mU6lSbK89M(@NotNull SNode __thisNode__) {
    return new NewExpressionAdapter(__thisNode__);
  }

  /*package*/ NewExpression__BehaviorDescriptor() {
    super(REGISTRY);
  }
