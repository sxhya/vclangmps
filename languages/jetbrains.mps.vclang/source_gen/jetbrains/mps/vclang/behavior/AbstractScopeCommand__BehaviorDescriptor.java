...
public final class AbstractScopeCommand__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x2db233bb72db49c3L, 0xadc47ae97f87f8dcL, 0x37ebde1aa3d4fe7fL, "jetbrains.mps.vclang.structure.AbstractScopeCommand");
  ...
  /*package*/ static Abstract.Statement toSourceStatement_id3wdrnIK4lOW(@NotNull SNode __thisNode__) {
    return new NamespaceCommandAdapter_(__thisNode__);
  }

  /*package*/ AbstractScopeCommand__BehaviorDescriptor() {
    super(REGISTRY);
  }
