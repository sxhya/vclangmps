...
public final class Constructor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Abstract.Definition toSourceDefinition_id5NQyKEZGoPp(@NotNull SNode __thisNode__) {
    return ((Abstract.Constructor) AbstractConstructor__BehaviorDescriptor.toSourceConstructor_id5NQyKEZH5E7.invoke(__thisNode__));
  }
  /*package*/ static Abstract.Constructor toSourceConstructor_id5NQyKEZH5E7(@NotNull SNode __thisNode__) {
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 1:
        return (T) ((Abstract.Constructor) toSourceConstructor_id5NQyKEZH5E7(node));
      case 2:
