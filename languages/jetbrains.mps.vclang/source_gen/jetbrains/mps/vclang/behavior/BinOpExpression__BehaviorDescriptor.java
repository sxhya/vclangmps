...
public final class BinOpExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static int getPriority_id6FOQVYN5Gn2(@NotNull SNode __thisNode__) {
    ...
    return ((int) AbstractBinOpExpression__BehaviorDescriptor.getPriority_id6FOQVYN5Gn2.invokeSpecial(__thisNode__));
  }
  /*package*/ static int getAssociativity_id6FOQVYN5Kbs(@NotNull SNode __thisNode__) {
    ...
    return ((int) AbstractBinOpExpression__BehaviorDescriptor.getAssociativity_id6FOQVYN5Kbs.invokeSpecial(__thisNode__));
  }
  ...
  /*package*/ BinOpExpression__BehaviorDescriptor() {
    super(REGISTRY);
  }
